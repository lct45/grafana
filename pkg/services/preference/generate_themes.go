...
func main() {
	...
	// JSON theme definitions are extra/experimental unless listed here.
	// First-class themes are emitted in the header below and skipped while walking.
	firstClassThemeIDs := map[string]bool{
		"cottoncandy": true,
	}
