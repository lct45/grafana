...
func addRecentItemMigrations(mg *Migrator) {
	...
	mg.AddMigration("add unique index recent_item.org_id-user_id-resource_type-resource_uid", NewAddIndexMigration(recentItemV1, recentItemV1.Indices[1]))
	mg.AddMigration("add index recent_item.org_id-user_id-last_viewed_at", NewAddIndexMigration(recentItemV1, recentItemV1.Indices[2]))
}
