...
import (
	...
	api3 "github.com/grafana/grafana/pkg/services/dashboardpins/api"
...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	exploreBookmarksService := explorebookmarks.ProvideService(sqlStore, routeRegisterImpl, accessControl)
	...
	dashboardPinsService := dashboardpins.ProvideService(sqlStore, dashboardService)
	api5 := api3.ProvideApi(dashboardPinsService)
