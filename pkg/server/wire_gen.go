...
import (
	...
	api3 "github.com/grafana/grafana/pkg/services/dashboardpin/api"
...
func Initialize(ctx context.Context, cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	dashboardpinService := dashboardpinimpl.ProvideService(sqlStore)
	api5 := api3.ProvideApi(dashboardpinService, dashboardService)
