...
type HTTPServer struct {
	...
	starApi                         *starApi.API
	dashboardPinsApi                *dashboardpinsapi.API
...
func ProvideHTTPServer(opts ServerOptions, cfg *setting.Cfg, routeRegister routing.RouteRegister, bus bus.Bus,
	...
	starApi *starApi.API, dashboardPinsApi *dashboardpinsapi.API, promRegister prometheus.Registerer, anonService anonymous.Service,
	...
	hs := &HTTPServer{
		...
		starApi:                      starApi,
		dashboardPinsApi:             dashboardPinsApi,
